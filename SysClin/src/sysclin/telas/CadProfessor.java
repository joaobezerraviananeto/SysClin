...
import sysclin.professor.ProfessorDAO;
import sysclin.usuario.UsuarioDAO;
import sysclin.util.Util;

public class CadProfessor extends javax.swing.JDialog {

    public CadProfessor(java.awt.Frame parent, boolean modal, Professor professor, boolean primeiroCadastro) {
        super(parent, modal);
        initComponents();
    ...
    private void atualizarCampos() {
        ...
        tfnasc.setText(Util.dateToString(professor.getDataNascimento()));
        tflogin.setText(professor.getLogin());
        tfsenha.setText(professor.getSenha());
        tfconfirma.setText(professor.getSenha());
        tfendereco.setText(professor.getEndereco());
        tfnumero.setText(String.valueOf(professor.getEnderecoNumero()));
        tfbairro.setText(professor.getBairro());
        tfcomplemento.setText(professor.getComplemento());
        Util.carregarComboBox(professor.getEstado(), tfestado);//===============================
        Util.carregarComboBox(professor.getCidade(), tfcidade);//===============================
    ...
    private void preencheDados() {
        ...
        professor.setNome(tfnome.getText().trim());
        professor.setTelefone(tftelefone.getText().trim());
        professor.setCpf(Util.formatarCPF(tfcpf.getText().trim()));
        professor.setDataNascimento(Util.stringToDate(tfnasc.getText().trim()));
        professor.setLogin(tflogin.getText().trim());
        professor.setSenha(Util.md5(tfsenha.getText().trim()));
        professor.setEndereco(tfendereco.getText().trim());
        professor.setEnderecoNumero(Integer.parseInt(tfnumero.getText().trim()));
        professor.setBairro(tfbairro.getText().trim());
        professor.setComplemento(tfcomplemento.getText().trim());
        professor.setCidade(tfcidade.getSelectedItem().toString());
        professor.setEstado(tfestado.getSelectedItem().toString());
        professor.setEmail(tfemail.getText().trim());
    ...
    private void initComponents() {
        ...
        jLabel22.setText("Cadastro de Professor");
    ...
    private void jBSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSalvarActionPerformed
        preencheDados();
        if (!Util.CPF(professor.getCpf())) {
            JOptionPane.showMessageDialog(null, "O CPF não e válido");
        } else if (usuariodao.isExistenteCPF(professor.getCpf()) != professor.getId()) {
            JOptionPane.showMessageDialog(null, "Este CPF já está cadastrado");
        } else if (professor.getEmail().equals("") || professor.getEmail() == null) {
            JOptionPane.showMessageDialog(null, "O EMail e obrigatório");
        } else if(Util.isEmailValido(professor.getEmail())){
            JOptionPane.showMessageDialog(null, "Este Email é inválido");
        }else if (usuariodao.isExistenteEmail(professor.getEmail()) != professor.getId()) {
            JOptionPane.showMessageDialog(null, "Este Email já está cadastrado");
        } else if (professor.getNome().equals("") || professor.getNome() == null) {
    ...
    public static void main(boolean primeiroCadastro) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                CadProfessor dialog = new CadProfessor(new javax.swing.JFrame(), true, new Professor(), primeiroCadastro);
