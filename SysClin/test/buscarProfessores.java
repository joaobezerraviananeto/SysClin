...
public class buscarProfessores extends javax.swing.JFrame {
    ...
    /**
     * Creates new form buscarProfessores
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscarProfessores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buscarProfessores().setVisible(true);
            }
        });
    }
